...
print('mean of T_m in 10m x 10m area of finding one box is', np.mean(mean_3))
print('mean of T_m in 20m x 20m area of finding one box is', np.mean(mean_4))
print('standard deviation of T_m in 10m x 10m area of finding one box is', np.std(total1))
print('standard deviation of T_m in 20m x 20m area of finding one box is', np.std(total2))
