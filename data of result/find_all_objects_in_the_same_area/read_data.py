...
# Transform data from txt to matrix
def readdata(route):
...
# Extract relevant data from the matrix
def extract_data_average(route1,route2):
    ...
    return average_experiment_data_time,average_experiment_data_number_of_information,performance_judgement,deviation_experiment_data_time,deviation_experiment_data_number_of_information,experiment_data_time,experiment_data_number_of_information
