...
# Read data(change the file name and you will get related results)
result1 = readdata('raw_material_of_time_find_one_box_ten_meters_width.txt')
result2 = readdata('raw_material_of_duplicate_information_find_one_box_ten_meters_width.txt')
variable_test = 30
trial = 90
...
plt.xlabel('Scan range',fontsize=15, color='k')
plt.ylabel('Robot',fontsize=15, color='k')
