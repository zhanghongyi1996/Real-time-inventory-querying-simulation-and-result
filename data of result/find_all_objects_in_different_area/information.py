...
# load raw data of duplicate information rate
information1 = a[6]
information2 = b[6]
...
print('mean of D_m in 10m x 10m area of finding all boxes is', np.mean(mean_3))
print('mean of D_m in 20m x 20m area of finding all boxes is', np.mean(mean_4))
print('standard deviation of D_m in 10m x 10m area of finding all boxes is', np.std(total1))
print('standard deviation of D_m in 20m x 20m area of finding all boxes is', np.std(total2))
